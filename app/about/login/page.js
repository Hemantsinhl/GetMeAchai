...
useEffect(() => {
    ...
    return (
        <div className='text-white py-14'>
            <h1 className='font-bold text-3xl fontbold text-center'>Login to Get Started</h1>
            <div className="social-login-buttons">
                <div className="flex flex-col items-center gap-2 min-h-screen p-10">


                    <button
                        className="flex w-64 items-center bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
