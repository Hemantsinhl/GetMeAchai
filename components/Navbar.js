...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex justify-between items-center px-4 md:h-16 flex-row'>
      ...
      <div className='relative flex flex-col mb-4 md:mb-0 justify-center items-center  md:block gap-4'>
        {session && <>
        ...
        {!session && <Link href={"/login"}>
          <button className='text-white bg-gradient-to-br mt-4 md:mt-0 from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 '>Login</button></Link>}
      </div>
    </nav>
  )
}
